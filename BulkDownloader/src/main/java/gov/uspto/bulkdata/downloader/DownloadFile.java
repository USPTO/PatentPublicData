...
public class DownloadFile implements Serializable {
	...
	@JsonCreator
	public DownloadFile(@JsonProperty("url") String url, @JsonProperty("tempFile") String tempFile,
			@JsonProperty("outFile") Path outFile, @JsonProperty("isComplete") boolean isComplete,

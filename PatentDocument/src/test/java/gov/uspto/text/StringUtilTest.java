...
public class StringUtilTest {
	...
	public void capitalizeFirstLetterTestString() {
		assertEquals("Computer", StringUtil.capitalizeFirstLetter("computer"));
	}

	@Test
	public void capitalizeFirstLetterTestArray() {
		assertEquals(new String[]{"Computer", "Laptop"}, StringUtil.capitalizeFirstLetter(new String[]{"computer", "laptop"}));
	}

	@Test
	public void TitleCaseTest(){
		for (Entry<String,String> validFromTo: TitleValidFromTo.entrySet()){
			assertEquals( validFromTo.getValue(), StringUtil.toTitleCase(validFromTo.getKey()));
		}
	}

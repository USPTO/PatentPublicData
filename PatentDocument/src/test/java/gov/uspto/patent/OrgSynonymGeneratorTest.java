...
public class OrgSynonymGeneratorTest {
	...
	static {
		...
		COMPANIES.put(entity("TELEFONICA DIGITAL ESPA�A, S.L.U.", CountryCode.ES), Arrays.asList("TELEFONICA DIGITAL ESPA�A"));
		...
		COMPANIES.put(entity("Conversant Wireless Lecensing S.a.r.l", CountryCode.LU), Arrays.asList("CONVERSANT WIRELESS LECENSING", "CONVERSANT WIRELESS LECENSING SOCI�T� ANONYME � RESPONSABILIT� LIMIT�E"));
		...
		// Italian (IT)
		COMPANIES.put(entity("F.LLI MARIS S.p.A.", CountryCode.IT), Arrays.asList("F.LLI MARIS", "F LLI MARIS", "F.LLI MARIS SOCIET� PER AZIONI"));
		...
		// Finish (FI)
		COMPANIES.put(entity("Siemens Osakeyhti�", CountryCode.FI), Arrays.asList("SIEMENS", "SIEMENS OY", "SIEMENS OSAKEYHTI�"));
		COMPANIES.put(entity("Siemens OY", CountryCode.FI), Arrays.asList("SIEMENS", "SIEMENS OY", "SIEMENS OSAKEYHTI�"));
		...
		COMPANIES.put(entity("Gebruder Boehringer G.m.b.H.", CountryCode.DE), Arrays.asList("GEBRUDER BOEHRINGER"));
		COMPANIES.put(entity("Allibert Exploitation Societe Anonyme", CountryCode.FR), Arrays.asList("ALLIBERT EXPLOITATION", "ALLIBERT EXPLOITATION S.A."));
		COMPANIES.put(entity("Aktiebolaget Electrolux", CountryCode.SE), Arrays.asList("ELECTROLUX"));

...
import gov.uspto.patent.xml.items.ClassificationIPCNode;
...
public class ClassificationNode extends DOMFragmentReader<Set<Classification>> {
	...
	private static final String IPC_PATH = "//classifications-ipcr/classification-ipcr";
	private static final String CPC_PATH = "//classifications-cpc";

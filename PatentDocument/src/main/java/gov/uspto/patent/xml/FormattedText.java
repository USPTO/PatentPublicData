...
public class FormattedText implements TextProcessor {
    ...
    private static final String[] HTML_WHITELIST_TAGS = new String[] { "p", "table", "tr", "td", "ul", "li", "span" };
    ...
    public String getPlainText(String rawText) {
        ...
        /*
         * crossref tags, remove since not useful in index; which are internal
         * links to another section.
         */
    ...
    public String getSimpleHtml(String rawText) {
         ...
         * 
         * <span idref="CLM-00001" class="claim">Patent-Claim</span>
         */
        for (Element element : document.select("claim-ref")) {

...
<li>Patent Document module can also read CPC Classification files - <a href="https://bulkdata.uspto.gov/data2/patent/classification/cpc/">Master CPC File</a> (contains current CPC classification for patents starting a patent number 1), and the <a href="http://www.cooperativepatentclassification.org/cpcSchemeAndDefinitions/Bulk.html">CPC Scheme</a> (CPC classification definitions)
</ul>

...
The WIPO generates a family id when a new id is given if an new <a href="https://en.wikipedia.org/wiki/Patent_Cooperation_Treaty">PCT application</a> does not belong to a family. The family id is not included in a patent's bibliography or within USPTO's bulk files.
